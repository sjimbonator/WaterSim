...
namespace WaterSim.Materials
{
    class TerrainMaterial : Material
    {
        ...
        public TerrainMaterial() : base(new Shader("Content/shaders/terrain/terrainShader.vert", "Content/shaders/terrain/terrainShader.frag"))
        {
            ...
            terrainMaterials["materials[0].lerpTreshold"] = 0.00f;
            ...
            terrainMaterials["materials[1].lerpTreshold"] = 0.01f;
            ...
            terrainMaterials["materials[2].lerpTreshold"] = 0.03f;
            ...
            terrainMaterials["materials[3].lerpTreshold"] = 0.25f;
            ...
            terrainMaterials["materials[4].lerpTreshold"] = 0.70f;
            ...
            terrainMaterials["materials[5].lerpTreshold"] = 0.99f;
        }
